...
- Live Ayder integration tests for `Http::query()` against a real RFC 10008 QUERY server
- Coverage for `Accept-Query`, `ETag`, `Content-Location`, and `If-None-Match` → `304` revalidation
...
[1.0.1]: https://github.com/mohamedahmed01/http-query-polyfill/releases/tag/v1.0.1
